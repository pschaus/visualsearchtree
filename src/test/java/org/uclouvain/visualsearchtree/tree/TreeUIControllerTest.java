...
class TreeUIControllerTest {
    ...
    void correct_stats_for_legend_box(FxRobot robot){
        Assertions.assertThat(robot.lookup("#innerCount").queryAs(Text.class).getText()).isEqualTo("  (2)");
    ...
    void node_behavior(FxRobot robot) {
        ...
        Assertions.assertThat( ((Text) tv.getFocusedRect().get(2)).getText()).isEqualTo("default");
    }
...
//    }
    ...
    private static void randomTree(Tree t){
        ...
        t.createNode(1,0, Tree.NodeType.FAIL,()->{System.out.println(1);},"{\"cost\": "+1+", \"domain\": "+1+", \"other\": test}");
        t.createNode(2,0, Tree.NodeType.FAIL,()->{System.out.println(2);},"{\"cost\": "+2+", \"domain\": "+2+", \"other\": test}");
        t.createNode(3,-1, Tree.NodeType.INNER,()->{System.out.println(3);},"{\"cost\": "+3+", \"domain\": "+3+", \"other\": test}");
        t.createNode(4,3, Tree.NodeType.SOLUTION,()->{System.out.println(4);},"{\"cost\": "+4+", \"domain\": "+4+", \"other\": test}");
        t.createNode(5,3, Tree.NodeType.FAIL,()->{System.out.println(5);},"{\"cost\": "+5+", \"domain\": "+5+", \"other\": test}");
        t.stopSearch();
    }
}